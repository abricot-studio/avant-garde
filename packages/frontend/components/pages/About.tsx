...
function Description() {
  ...
  return (
    <>
      ...
      <Card mt={8} p={8}>
        <Paragraph>
          Images are automatically generated by deep-learning algorithms. It
          takes as input your wallet address and create a unique image as an
          output. No two images are similar.
        </Paragraph>
        <Paragraph pt={4}>
          Under the hood, AvantGarde uses TensorFlow, using neural network
          architecture to output a matrix of 3 values, defining RGB color for
          each pixel location. The Compositional pattern-producing network
          (CPPN) is composed of dense layers fully connected and activated by
          tangent hyperbolic functions. This network layer kernel bias are
          initialized with a determinist vector of initialisation derived from
          your ethereum address. Each pixel 2d coordinate vector get across the
          network and output RGB values.
        </Paragraph>
      </Card>
      ...
      <Card mt={8} p={8}>
        <Paragraph>
          ...
          the blockchain and become its owner. Only you can mint the unique
        ...
        <Paragraph pt={4}>
          With AvantGarde, you art will be forever available online! Ownership
          is stored on a decentralized ledger and the image on{' '}
      ...
      <Card mt={4} p={8}>
        ...
        <Collapse in={isOpenBondingCurve} animateOpacity startingHeight={1}>
          <Paragraph>
            A bonding curve is a mathematical function defining a buy and sell
            price depending on the number of circulating tokens at a given
            moment. The more token are created, the higher get the price. When
            token are burned, the price goes down.
          </Paragraph>
        </Collapse>
        <SubTitle>
          Minting
        ...
        <Collapse in={isOpenBurning} animateOpacity startingHeight={1}>
          <Paragraph>
            In addition to the secondary market, token holders can come anytime
            on this app and sell their token at the price defined by the bonding
            curve. Our Smart-Contracts acts as an Automated Market Maker, and
            always has enough funds to re-buy your art, which comes from mint
            fees.
          </Paragraph>
          <Paragraph pt={4}>
        ...
        <Collapse in={isOpenRational} animateOpacity startingHeight={1}>
          <Paragraph>
            ...
            If you want to learn more about them, we suggest you to read more
            about them there.
          </Paragraph>
          <Paragraph pt={4}>
            Regarding platform fees, some may say they are usually paid at
            burning time. We decided to put them at minting because we don't
            want to incite people to burn art, while we still want to rewards
            the artists.
          </Paragraph>
        </Collapse>
        <SubTitle>
