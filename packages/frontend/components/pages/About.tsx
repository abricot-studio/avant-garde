...
const Title = ({ children }) => (
  <Heading textAlign="center" mt={4} mb={4} fontSize={20}>
    {children}
  </Heading>
)
const SubTitle = ({ children }) => (
  <Heading textAlign="left" mt={4} ml={4} mb={2} fontSize={16}>
    {children}
  </Heading>
)
const Paragraph = ({ children }) => (
  <Text align="justify" mb={1} fontSize="md">
    {children}
  </Text>
)
...
function Description() {
  return (
    <>
      <Paragraph>AvantGarde is a digital artwork platform.</Paragraph>
      <Paragraph>
