...
import {
  ...
  IconButton,
  Image,
  Link as CLink, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay,
  SocialLink,
  Spinner,
  Text,
  useBreakpointValue,
...
function BurnButton({ token, isOpen, onToggle, onClick, burned, isBurning, tokenBurnPrice }) {
...
${tags}`
      messageReddit = `Look at this unique generative art I created! 💘
...
generated by a deep-learning algorithm 🎨`
  ...
  }, [isMounted, account, token, contractAddress, chainId])
          ...
          <ModalContent pb={4}>
            ...
            <ModalBody py={0}>
              <Flex align="center" direction="column">
                <Text pb={4}>
                  This action can't be reverse, your piece will be destroyed forever and you will not be able to mint a new one in the futur.
                </Text>
                  ...
                  <Flex>
                    ...
                    {tokenBurnPrice && (
                      <Button
                        ...
                        mt={2}
                        mx={2}
                        onClick={() => { burn(token.id); onCloseModal()}}
                      >
                        Burn for Ξ
                        {utils.formatEther(
                          utils.parseUnits(tokenBurnPrice.currentPrice, 'wei')
