...
export default function Token({ id }) {
  ...
  const socialPostUrls = useMemo(() => {
    ...
    let messageTwitter = `Look at this unique #generativeart piece of #art !💘
...
${tags}`
    let messageReddit = `Look at this unique #generativeart piece of #art !💘

Join the AvantGardists to discover your personalized AvantGarde #NFT, 🔥
generated by a deep-learning algorithm 🎨`

    if (account && addressEqual(account, token.owner)) {
      messageTwitter = `Look at this unique #generativeart piece of #art !💘
...
${tags}`
      messageReddit = `Look at this unique #generativeart piece of #art !💘

Join the AvantGardists to discover your personalized AvantGarde #NFT, 🔥
generated by a deep-learning algorithm 🎨`
    }

    const reddit = `https://reddit.com/submit?url=${permalink}&title=${messageReddit}`
  ...
  }, [account, token, contractAddress, chainId])
