...
import { ActionButton, Box, Text, Center, Heading, SocialLink, Button, Flex} from '../components/ui'
    ...
    <>
      ...
      <Layout>
        <Heading textAlign="center" mb={8} fontFamily="Poppins, sans-serif">
          { registrationResult ? 'Thank you, see you again on the 15th of July' : 'Be part of the AvantGardist!' }
        </Heading>
